...
switch degree
    ...
    case 3
        ...
        % Face centroids (nodes 17-20) must match lagrange3D ordering:
        % f123(opp4), f124(opp3), f134(opp2), f234(opp1).
        elem_e(:, 17) = offFC + faceIdx(:, 4);
        elem_e(:, 18) = offFC + faceIdx(:, 3);
        elem_e(:, 19) = offFC + faceIdx(:, 2);
        elem_e(:, 20) = offFC + faceIdx(:, 1);
